...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_KL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, LT_APPS, MO(_FL),  KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_NL] = LAYOUT(
        ...
        _______, _______, _______,                   _______,                            _______, _LAYER_, _______, _______,            _______, _______, _______
    ),
    [_FL] = LAYOUT(
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [_FL] = {
        ...
        CHART,     GOLD,    CORAL,   OFF,     OFF,     OFF,     OFF,     RED,     {1,0,0}, CYAN,    M9B59B5, OFF,     OFF,
